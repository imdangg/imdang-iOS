...
struct InsightSectionInfo {
    ...
    static let surroundEnvironment: InsightSectionInfo = InsightSectionInfo(title: "주변환경", subTitle: nil, description: "복수 선택 가능", buttonTitles: ["해당 없음", "강", "산", "공원", "산책로", "식당가", "시장"])
